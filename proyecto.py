...
navbar = dbc.Navbar( id = 'navbar', children = [
    dbc.Row([
        ...
        dbc.Col(
            dbc.NavbarBrand("Dashboard interactivo de cuentahabitantes del banco", style = {'color':'white', 'fontSize':'25px','fontFamily':'Times New Roman'}
                            )
...
card_content_dropdwn = [
    dbc.CardBody(
        [
            html.H6('Selecione el mes', style = {'textAlign':'center'}),
...
def update_cards(base, comparison):
    ...
    if diff_1 >= 0:
        a =   dcc.Markdown( dangerously_allow_html = True,
                   children = ["<sub>+{0}{1}{2}</sub>".format('$',diff_1,'K')], style = {'textAlign':'center'})
        
    elif diff_1 < 0:
        
        a =    dcc.Markdown( dangerously_allow_html = True,
                   children = ["<sub>-{0}{1}{2}</sub>".format('$',np.abs(diff_1),'K')], style = {'textAlign':'center'})
            
    if diff_holi >= 0:
        b =   dcc.Markdown( dangerously_allow_html = True,
                   children = ["<sub>+{0}{1}{2}</sub>".format('$',diff_holi,'K')], style = {'textAlign':'center'})
        
    elif diff_holi < 0:
        
        b =   dcc.Markdown( dangerously_allow_html = True,
                   children = ["<sub>-{0}{1}{2}</sub>".format('$',np.abs(diff_holi),'K')], style = {'textAlign':'center'})
    ...
    card_content = [
        ...
        dbc.CardBody(
            [
                html.H6('Ingresos total', style = {'fontWeight':'lighter', 'textAlign':'center'}),
                
                html.H3('{0}{1}{2}'.format("$", sales_base, "K"), style = {'color':'#090059','textAlign':'center'}),
    ...
    card_content1 = [
        ...
        dbc.CardBody(
            [
                html.H6('Diferencia total', style = {'fontWeight':'lighter', 'textAlign':'center'}),
                
                html.H3('{0}{1}{2}'.format("$", holi_base, "K"), style = {'color':'#090059','textAlign':'center'}),
    ...
    card_content2 = [
        ...
        dbc.CardBody(
            [
                html.H6('Total de cuentahabitantes', style = {'fontWeight':'lighter', 'textAlign':'center'}),
                
                html.H3('{0}'.format( 15434), style = {'color':'#090059','textAlign':'center'}),
    ...
    card_content3 = [
        ...
        dbc.CardBody(
            [
                html.H6('Comparacion de ingresos totales por semana', style = {'fontWeight':'bold', 'textAlign':'center'}),
    ...
    card_content4 = [
        ...
        dbc.CardBody(
            [
                html.H6('Comparativa entre clientes con mayores ingresos', style = {'fontWeight':'bold', 'textAlign':'center'}),
    ...
    card_content5 = [
        ...
        dbc.CardBody(
            [
                html.H6('Total de deudas acumuladas entre ({} - {})'.format(base, comparison), style = {'fontWeight':'bold', 'textAlign':'center'}),
